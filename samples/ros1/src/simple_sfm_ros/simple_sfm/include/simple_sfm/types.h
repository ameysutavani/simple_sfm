...
namespace simple_sfm
{
    namespace types
    {
        ...
        /// @brief Structure representing point to projection associations (observations).
        template <typename ScalarType = DefaultScalarType>
        struct Observation
        {
            size_t camera_index{};
        ...
        /// @brief A convenient structure to hold the variables of the SfM problem. These parts will be optimized.
        /// @tparam ScalarType
        template <typename ScalarType = DefaultScalarType>
        struct SfmVariables
        {
        ...
        /// @brief A convenient structure to hold the observations of the SfM problem. These parts will be used as constants.
        /// @tparam ScalarType
        template <typename ScalarType = DefaultScalarType>
